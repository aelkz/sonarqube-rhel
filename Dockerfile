FROM docker-registry.default.svc:5000/openshift/openjdk-11-rhel7
...
ENV ORIGINAL_PLUGINS_FOLDER="/extensions/plugins-original"
ENV PVC_PLUGINS_FOLDER="$SONARQUBE_HOME/extensions/plugins"
...
RUN useradd -r sonarqube \
	...
	&& /usr/bin/fix-permissions $ORIGINAL_PLUGINS_FOLDER \
